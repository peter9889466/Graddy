...
public class AICurriculumService {
    ...
    public AICurriculumResponse generateCurriculum(Long studyId) {
        try {
            // 스터디 정보 조회
            ...
            // 스터디의 관심 태그들 조회
            List<Tag> tags = tagRepository.findByStudyId(studyId);
            ...
            ProcessBuilder processBuilder = new ProcessBuilder(
                ...
                study.getStudyTitle(),
                study.getStudyDesc(),
                study.getStudyLevel().toString(),
                String.join(",", interestNames),
                study.getStudyStart().toString(),
                study.getStudyEnd().toString()
            );
