...
const JoinTime: React.FC<JoinTimeProps> = ({
    ...
    const toggleAllDays = () => {
        const hasAnyDaySelected = Object.values(selectedDays).some(
            (day) => day
        );
    ...
    const completeSignup = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://ec2-3-113-246-191.ap-northeast-1.compute.amazonaws.com/api/join",
                requestBody,
                {
                    headers: {
    ...
    const handlePrevious = () => {
        if (onPrevious) {
            ...
            navigate("/join-interest", {
                // 경로를 JoinInterest로 변경
                state: {
                    formData: formData,
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="p-8">
                            ...
                            >
                                <div
                                    className={`flex items-center gap-2 p-4 rounded-xl border ${
                                        hintMessage.includes("완료") ||
                                        hintMessage.includes("선택되었습니다")
                        ...
                        {/* Selection Summary */}
                        <div
                            className="mb-8 p-6 bg-white border-2 rounded-2xl shadow-sm"
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="text-sm text-gray-600">
                                        ...
                                        >
                                            {isTimeSlotValid()
                                                ? `${customTimeSlot.startTime}시 - ${customTimeSlot.endTime}시`
                                                : "미선택"}
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div
                            className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border rounded-2xl"
                            style={{ borderColor: "rgba(139, 133, 233, 0.3)" }}
                        >
                            ...
                            <button
                                ...
                                style={
                                    isFormComplete()
                                        ? {
                                              background:
                                                  "linear-gradient(135deg, #8B85E9 0%, #9C92FF 100%)",
                                              boxShadow:
                                                  "0 20px 25px -5px rgba(139, 133, 233, 0.3), 0 10px 10px -5px rgba(139, 133, 233, 0.1)",
                                          }
                                        : {}
                                }
