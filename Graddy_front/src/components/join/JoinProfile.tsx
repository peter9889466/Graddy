...
const JoinProfile: React.FC<JoinProfileProps> = ({
    navigate,
    location,
    onNext,
}) => {
    ...
    const handleSendVerification = async () => {
        ...
        try {
            ...
            if (unifiedResponse.data.status === 400) {
                ...
                unifiedResponse.data.status === 200 &&
                                            ...
                                            validatePhoneNumber(
                                                ...
                                                ? {
                                                      backgroundColor:
                                                          "#8B85E9",
                                                      boxShadow:
                                                          "0 4px 6px -1px rgba(139, 133, 233, 0.1)",
                                                  }
                                                : {}
                                        }
                                    >
