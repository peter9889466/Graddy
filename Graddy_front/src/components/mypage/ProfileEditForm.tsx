...
const ProfileEditForm: React.FC<ProfileEditFormProps> = ({
    ...
    const onCheckNickname = async () => {
        ...
        try {
            const response = await axios.get("http://ec2-3-113-246-191.ap-northeast-1.compute.amazonaws.com/api/join/check-nick", {
    ...
    const handleSendVerification = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post("http://ec2-3-113-246-191.ap-northeast-1.compute.amazonaws.com/api/api/phone-verification/unified", {
                tel: phoneNumber,
    ...
    const handleVerifyCode = async () => {
        ...
        const phoneNumber = phonePrefix + phoneMiddle + phoneLast;
        try {
            const response = await axios.post("http://ec2-3-113-246-191.ap-northeast-1.compute.amazonaws.com/api/auth/verify-code", {
