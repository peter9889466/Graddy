...
const allInterests: InterestItem[] = [
    { id: 1, name: "Python" }, { id: 2, name: "JavaScript" }, { id: 3, name: "Java" },
    { id: 4, name: "C++" }, { id: 5, name: "C" }, { id: 6, name: "TypeScript" },
    { id: 7, name: "Kotlin" }, { id: 8, name: "Swift" }, { id: 9, name: "Go" },
    { id: 10, name: "PHP" }, { id: 11, name: "Dart" }, { id: 12, name: "Rust" },
    { id: 13, name: "Ruby" }, { id: 14, name: "Assembly" }, { id: 15, name: "React" },
    { id: 16, name: "Node.js" }, { id: 17, name: "Spring" }, { id: 18, name: "Spring Boot" },
    { id: 19, name: "Django" }, { id: 20, name: "Flask" }, { id: 21, name: "Vue" },
    { id: 22, name: "Pandas" }, { id: 23, name: "Unity" }, { id: 24, name: "Linux" },
];
...
const Join2: React.FC = () => {
    ...
    const getSelectedInterestClasses = (item: SelectedInterestItem) => {
        const { bgColor, textColor } = getDifficultyColors(item.difficulty);
        return `px-3 py-1 text-sm rounded-full flex items-center space-x-1 ${bgColor} ${textColor}`;
    };
    ...
    return (
        ...
        <div className="w-1/2">
            {/* 바깥 테두리 안쪽 전체 */}
            <div
            className="bg-white rounded-xl p-8 shadow-sm border-2 flex flex-col justify-center items-center h-[80vh] w-full"
            style={{ borderColor: "#8B85E9" }}
            >
            <h2 className="text-xl sm:text-2xl font-bold mb-2" style={{ color: "#8B85E9" }}>
                관심분야 선택
            </h2>
            ...
            <div className="relative w-3/5 mb-6">
                <input
                    ...
                    style={{ borderColor: "#8B85E9" }}
                    onFocus={(e) =>
                        (e.target.style.boxShadow = "0 0 0 2px rgba(139, 133, 233, 0.2)")
                    }
...
<div className="flex flex-wrap gap-2 text-sm justify-center mb-6">
    {["전체", "프로그래밍 언어", "프레임워크/라이브러리", "기술 분야", "플랫폼/도구", "역할/직무"].map((cat, idx) => (
        <button
            key={idx}
            className={`px-4 py-2 rounded-full font-medium ${
                idx === 0 ? "text-white bg-[#8B85E9]" : "text-gray-600 bg-gray-200"
            }`}
        >
            {cat}
        </button>
            ...
            {/* 난이도 + 관심분야 목록 */}
            <div className="flex flex-row gap-6 w-4/5 mb-6">
                {/* 난이도 선택 */}
                ...
                {["상", "중", "하"].map((level) => (
                    ...
                    className={`w-12 h-12 flex items-center justify-center rounded-full font-bold shadow-md ${
                        activeDifficulty === level ? "ring-2 ring-[#8B85E9]" : ""
                    } ${
                        level === "상"
            ...
            {/* 관심분야 목록 */}
            <div
                className="p-4 border rounded-xl overflow-y-auto flex-1"
            ...
            {/* 선택된 관심분야 */}
            <div className="w-4/5">
                <h3 className="font-medium mb-2" style={{ color: "#8B85E9" }}>
                선택한 관심분야
                </h3>
                <div
                ...
                {selectedInterests.map((item) => (
                    <span key={item.id} className={getSelectedInterestClasses(item)}>
                    <span>{item.name}</span>
            ...
            {/* 하단 버튼 */}
            <div className="flex justify-center space-x-4 pt-6 w-4/5">
                <button
                ...
                style={{ backgroundColor: "#8B85E9", width: "calc(100% / 2.5)" }}
                onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#7A73E0")}
                onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = "#8B85E9")}
                >
                회원가입
                </button>
                <button
                ...
                style={{ backgroundColor: "#E0E0E0", color: "#555", width: "calc(100% / 2.5)" }}
