                    ...
                    <div className="space-y-6 w-3/5">
                        ...
                        <div className="relative">
                            <input
                                ...
                                style={{ borderColor: "#8B85E9" }}
                                onFocus={(e) => e.target.style.boxShadow = "0 0 0 2px rgba(139, 133, 233, 0.2)"}
                        ...
                        <div className="flex flex-wrap gap-2 text-sm justify-center">
                            {["전체", "프로그래밍 언어", "프레임워크/라이브러리", "기술 분야", "플랫폼/도구", "역할/직무"].map((cat, idx) => (
                                <button
                                    key={idx}
                                    className={`px-4 py-2 rounded-full font-medium ${idx === 0 ? "text-white" : "text-gray-600"} ${idx === 0 ? "bg-[#8B85E9]" : "bg-gray-200"}`}
                                >
                                    {cat}
                                </button>
                            ))}
                        ...
                        {/* 관심분야 목록 */}
                        <div className="p-4 border rounded-xl overflow-y-auto" style={{ borderColor: "#8B85E9", maxHeight: "200px" }}>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="p-4 border rounded-xl flex flex-wrap gap-2" style={{ borderColor: "#8B85E9", minHeight: "60px" }}>
                                {selectedInterests.map((item) => (
                                    <span key={item.id} className="px-3 py-1 text-sm rounded-full flex items-center space-x-1" style={{ backgroundColor: "#8B85E9", color: "white" }}>
                                        <span>{item.name}</span>
                        ...
                        <div className="flex justify-center space-x-4 pt-4">
                            ...
                            <button
                                ...
                                style={{ backgroundColor: "#E0E0E0", color: "#555", width: "calc(100% / 3)" }}
